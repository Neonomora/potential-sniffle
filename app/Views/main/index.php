...
<div class="container mt-5 mb-5">
    ...
    <form action="<?= base_url('/main/store') ?>" method="post" enctype="multipart/form-data">
        ...
        form_radiobox('Pemberi Layanan Kesigmul', 'pemberi_layanan', [
            'Tidak', 'Ya(Praktik)', 'Ya(Pendidikan)'
        ]);
        form_select('Level Kompetensi (ASN/Non ASN', 'level', [
            'PRA TGMK', 'TGMK1', 'TGMK2', 'TGMK3', 'TGMK4', 'TGMK5'
        ]);
        form_radiobox('Penghasilan', 'gaji', [
            '0', '< 1.000.000', '1.000.000 — 1.499.999', '1.500.000 — 1.999.999',
            '2.000.000 — 2.999.999', '3.000.000 — 3.999.999', '4.000.000 — 5.000.000'
        ]);
        form_select('Pangkat', 'pangkat', [
            'IIA Pengatur Muda', 'IIB Pengatur Muda Tingkat I', 'IIC Pengatur',
            'IID Pengatur Tingkat I', 'IIA Penata Muda', 'IIB Penata Muda Tingkat I',
            'IIC Penata', 'IID Penata Tingkat I', 'IVA Pembina', 'IVB Pembina Tingkat I',
